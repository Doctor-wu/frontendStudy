...
var BinarySearchTreeNode = /** @class */ (function () {
    function BinarySearchTreeNode(key) {
        this.key = key;
        this.parent = null;
        this.left = null;
        this.right = null;
...
var BinarySearchTree = /** @class */ (function () {
    ...
    BinarySearchTree.prototype.insert = function (key) {
        var node = new BinarySearchTreeNode(key);
        var p = this.root;
        // 尾指针
        var tail = this.root;
        while (tail) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [5 /*yield**/, __values(this.inorder(node.left))];
                case 1:
                    _a.sent();
                    _a.label = 2;
                case 2: return [4 /*yield*/, node];
                case 3:
                    _a.sent();
                    if (!node.right) return [3 /*break*/, 5];
                    return [5 /*yield**/, __values(this.inorder(node.right))];
                case 4:
                    _a.sent();
                    _a.label = 5;
